   ...
   /*! License details at fancyapps.com/license */ (function (e, t) {
      ...
      function $() {
         ...
         let H = {
            ...
            spring: function (e = {}) {
               t = z.Spring;
               let { velocity: n, mass: o, tension: i, friction: l, restDelta: m, restSpeed: p, maxSpeed: h, clamp: v } = { velocity: 0, mass: 1, tension: 170, friction: 26, restDelta: 0.1, restSpeed: 0.1, maxSpeed: 1 / 0, clamp: !0, ...e };
               return (r = n), (a = o), (s = i), (c = l), (f = m), (d = p), (u = h), (g = v), (M = {}), H;
            },
            isRunning: function () {
               return e === w.Running;
            },
            ...
            repeat: function (e, t = 0, n = k.Loop, o) {
               return (L = e), (S = t), (T = n), (P = o || i), H;
            },
            on: function (e, t) {
               return C.set(e, [...(C.get(e) || []), t]), H;
            },
            off: function (e, t) {
               return (
                  C.has(e) &&
            ...
            start: function (t) {
               return (e = w.Initializing), y((p = { ...v }), x) || (I.add(this), F || (F = window.requestAnimationFrame(E)), A(t)), H;
            },
            pause: function () {
               return h && (clearTimeout(h), (h = null)), e === w.Running && ((e = w.Paused), R("pause", v)), H;
            },
            end: _,
            tick: function (n) {
               n > b && (n = b), (o += n);
               ...
               if (t === z.Spring) {
                  ...
                  for (let n in v) {
                     ...
                     M[n] || ("object" == typeof r && "number" == typeof r[n] ? (M[n] = r[n]) : "number" == typeof r ? (M[n] = r) : (M[n] = 0));
                     let l = M[n],
               ...
               let L = { ...x };
               return R("step", v, p, x, h), E && e === w.Running && y(x, L) && ((e = w.Completed), _()), H;
            },
         ...
         G = (e, t) => {
            ...
            function S(e) {
               let t = j(a),
                  ...
                  f = { srcEvent: i, isPanRecognized: c, isSwipeRecognized: u, firstTouch: r, previousTouch: s, currentTouch: a, deltaX: m, deltaY: p, offsetX: h, offsetY: v, velocityX: y, velocityY: b, velocity: d, angle: E, axis: o, scale: t && l ? t / l : 0, center: n };
            ...
            function C(e) {
               ...
               let m = Date.now(),
                  p = m - (f || m);
               (d = p > 0 && p <= 250), (f = m), clearTimeout(x), (i = e), e instanceof MouseEvent && (window.addEventListener("mousemove", R), window.addEventListener("mouseup", A)), window.addEventListener("blur", O), (r = [...(a = H(e))]), (s = []), (g = a.length), (n = V(a)), 1 === g && ((c = !1), (u = !1)), g && T(V(a)), S("start");
            }
            function R(e) {
               if (!r.length || e.defaultPrevented) return;
               (i = e), (s = [...a]), (g = (a = H(e)).length);
               let t = (n = V(a)),
                  u = V(s);
               if (((m = t.x - u.x), (p = t.y - u.y), T(t), P(), S("move"), a.length > 1 && Math.abs(j(a) - j(s)) >= 0.1 && S("pinch"), !c && r.length)) {
                  let e = V(r);
                  (h = t.x - e.x), (v = t.y - e.y), (c = Math.abs(h) > l.panThreshold || Math.abs(v) > l.panThreshold) && ((Z = !1), clearTimeout(M), (M = 0), (o = (E = Math.abs((180 * Math.atan2(v, h)) / Math.PI)) > 45 && E < 135 ? "y" : "x"), (r = [...a]), (s = [...a]), window.getSelection()?.removeAllRanges(), S("panstart"));
               }
               c && (m || p) && S("pan");
            }
            function A(e) {
               ...
               let t = H(e),
                  o = D(e);
               if (((g = t.length), (n = V(o)), o.length && T(V(o)), P(), (s = [...a]), (a = [...t]), (r = [...t]), t.length > 0)) S("end"), (c = !1), (u = !1), (w = []);
               else {
            ...
            let I = {
               init: function () {
                  if (e) return e.addEventListener("click", k, q), e.addEventListener("mousedown", C, q), e.addEventListener("touchstart", C, q), e.addEventListener("touchmove", R, q), e.addEventListener("touchend", A), e.addEventListener("touchcancel", A), I;
               },
               on: function (e, t) {
               ...
               isPointerDown: () => g > 0,
               destroy: function () {
                  clearTimeout(x), clearTimeout(M), (M = 0), e && (e.removeEventListener("click", k, q), e.removeEventListener("mousedown", C, q), e.removeEventListener("touchstart", C, q), e.removeEventListener("touchmove", R, q), e.removeEventListener("touchend", A), e.removeEventListener("touchcancel", A)), (e = null), z();
               },
            };
            return I;
         };
      ...
      let Y = { IMAGE_ERROR: "This image couldn't be loaded. <br /> Please try again later.", MOVE_UP: "Move up", MOVE_DOWN: "Move down", MOVE_LEFT: "Move left", MOVE_RIGHT: "Move right", ZOOM_IN: "Zoom in", ZOOM_OUT: "Zoom out", TOGGLE_FULL: "Toggle zoom level", TOGGLE_1TO1: "Toggle zoom level", ITERATE_ZOOM: "Toggle zoom level", ROTATE_CCW: "Rotate counterclockwise", ROTATE_CW: "Rotate clockwise", FLIP_X: "Flip horizontally", FLIP_Y: "Flip vertically", RESET: "Reset", TOGGLE_FS: "Toggle fullscreen" },
         ...
         Q = (e, t = K) => Math.round(((e = parseFloat(e + "") || 0) + Number.EPSILON) * t) / t,
         ee = (((S = {}).Reset = "reset"), (S.Zoom = "zoom"), (S.ZoomIn = "zoomIn"), (S.ZoomOut = "zoomOut"), (S.ZoomTo = "zoomTo"), (S.ToggleCover = "toggleCover"), (S.ToggleFull = "toggleFull"), (S.ToggleMax = "toggleMax"), (S.IterateZoom = "iterateZoom"), (S.Pan = "pan"), (S.Swipe = "swipe"), (S.Move = "move"), (S.MoveLeft = "moveLeft"), (S.MoveRight = "moveRight"), (S.MoveUp = "moveUp"), (S.MoveDown = "moveDown"), (S.RotateCCW = "rotateCCW"), (S.RotateCW = "rotateCW"), (S.FlipX = "flipX"), (S.FlipY = "flipY"), (S.ToggleFS = "toggleFS"), S),
         et = (((T = {}).Cover = "cover"), (T.Full = "full"), (T.Max = "max"), T),
         en = { x: 0, y: 0, scale: 1, angle: 0, flipX: 1, flipY: 1 },
         eo = (((P = {})[(P.Init = 0)] = "Init"), (P[(P.Loading = 1)] = "Loading"), (P[(P.Error = 2)] = "Error"), (P[(P.Ready = 3)] = "Ready"), (P[(P.Destroyed = 4)] = "Destroyed"), P),
         ei = { bounds: !0, classes: { container: "f-panzoom", wrapper: "f-panzoom__wrapper", content: "f-panzoom__content", viewport: "f-panzoom__viewport" }, clickAction: ee.ToggleFull, dblClickAction: !1, gestures: {}, height: "auto", l10n: Y, maxScale: 4, minScale: 1, mouseMoveFactor: 1, panMode: "drag", protected: !1, singleClickAction: !1, spinnerTpl: '<div class="f-spinner"></div>', wheelAction: ee.Zoom, width: "auto" },
         el = 0,
         er = 0,
         ea = 0,
         es = (e, n = {}, o = {}) => {
            ...
            function T() {
               return e && e.parentElement && i && b === eo.Ready;
            }
            let P = new Map();
            function C(e, ...t) {
               let n = [...(P.get(e) || [])];
               for (let o of (E.on && n.push(E.on[e]), n)) o && o instanceof Function && o(eS, ...t);
               "*" !== e && C("*", e, ...t);
            }
            function R(e) {
               if (!T() || u(e.target)) return;
               let t = Date.now(),
                  n = m(
                     -1,
               ...
               if (o === ee.Zoom) {
                  ...
                  let r = B(),
                     a = et();
                  if ((Q(l) < Q(r) && Q(i) <= Q(r) ? ((ea += Math.abs(n)), (l = r)) : Q(l) > Q(a) && Q(i) >= Q(a) ? ((ea += Math.abs(n)), (l = a)) : ((ea = 0), (l = m(r, l, a))), ea > 7)) return;
               }
               switch ((J(e), o)) {
                  case ee.Pan:
                     ...
                     break;
                  case ee.Zoom:
                     ed(ee.ZoomTo, { srcEvent: e, scale: l, center: { x: e.clientX, y: e.clientY } });
                     break;
                  default:
                     ed(o, { srcEvent: e });
               }
            ...
            function A(n) {
               ...
               if (!G.isClickAllowed() || !a(o) || n.defaultPrevented || !e?.contains(o) || o.hasAttribute("disabled") || o.hasAttribute("aria-disabled")) return;
               ...
               let c = { srcEvent: n };
               if ((ed(S("clickAction"), c), S("dblClickAction"))) {
                  let e = Date.now(),
                     n = e - (el || e);
                  (el = e),
                     n > 0 && n <= 250
                        ? (t && (clearTimeout(t), (t = void 0)), ed(S("dblClickAction"), c))
                        : (t = setTimeout(() => {
                             ed(S("singleClickAction"), c);
                          }, 250));
               }
            }
            function O(e) {
               if (((v = e), !T() || !j() || x.scale <= 1 || M.scale <= 1 || (i?.dataset.animationName || "").indexOf("zoom") > -1)) return;
               let t = N(M.scale);
               if (!t) return;
               let { x: n, y: o } = t;
               ed(ee.Pan, { deltaX: n - M.x, deltaY: o - M.y });
            }
            function z() {
            ...
            function k() {
               if (!e || !l) return;
               if ((z(), l instanceof HTMLImageElement && !(l.complete && l.naturalWidth))) {
                  (b = eo.Error), i?.classList.add("has-error"), C("error");
                  return;
               }
               C("loaded");
               let { width: t, height: n } = _();
               l instanceof HTMLImageElement && (l.setAttribute("width", t + ""), l.setAttribute("height", n + "")),
                  i && (X(i, "has-error"), l instanceof HTMLImageElement && (i.setAttribute("width", t + ""), i.setAttribute("height", n + ""), (i.style.aspectRatio = `${t / n || ""}`))),
                  (g = $()
                     .on("start", (e, t) => {
                        void 0 !== t.angle && (t.angle = 90 * Math.round(t.angle / 90)), void 0 !== t.flipX && (t.flipX = t.flipX > 0 ? 1 : -1), void 0 !== t.flipY && (t.flipY = t.flipY > 0 ? 1 : -1), (M = { ...en, ...t }), eu(), C("animationStart");
                     })
                     .on("pause", (e) => {
                        M = { ...en, ...e };
                     })
                     .on("step", (e) => {
                        if (!T()) return void g?.end();
                        if (((x = { ...en, ...e }), j() || !S("bounds") || eE() || M.scale > x.scale || M.scale < W())) return void ef();
                        let t = es(M.scale),
                           n = !1,
                           o = !1,
                           i = !1,
                           l = !1;
                        x.x < t.x[0] && (n = !0), x.x > t.x[1] && (o = !0), x.y < t.y[0] && (l = !0), x.y > t.y[1] && (i = !0);
                        let r = !1,
                           a = !1,
                           s = !1,
                           c = !1;
                        M.x < t.x[0] && (r = !0), M.x > t.x[1] && (a = !0), M.y < t.y[0] && (c = !0), M.y > t.y[1] && (s = !0);
                        let u = !1;
                        ((o && a) || (n && r)) && ((M.x = m(t.x[0], M.x, t.x[1])), (u = !0)),
                           ((i && s) || (l && c)) && ((M.y = m(t.y[0], M.y, t.y[1])), (u = !0)),
                           u &&
                              g &&
                              g
                                 .spring({ tension: 94, friction: 17, maxSpeed: 555 * M.scale, restDelta: 0.1, restSpeed: 0.1, velocity: g.getCurrentVelocities() })
                                 .from(x)
                                 .to(M)
                                 .start(),
                           ef();
                     ...
                     .on("end", () => {
                        ec(), g?.isRunning() || (eu(), C("animationEnd"));
                     })),
                  (function () {
                     let e = S("gestures");
                     e &&
                        ...
                        (f = G(d, e)
                           .on("start", (e) => {
                              if (!g) return;
                              let t = e.srcEvent;
                              j() || ((x.scale > 1 || e.currentTouch.length > 1) && (t?.stopPropagation(), g.pause()), 1 === e.currentTouch.length && C("touchStart"));
                           })
                           .on("move", (e) => {
                              !j() && (1 !== M.scale || e.currentTouch.length > 1) && (J(e.srcEvent), e.srcEvent?.stopPropagation());
                           })
                           .on("pan", (e) => {
                              if (!T() || j()) return;
                              let t = e.srcEvent;
                              (1 !== M.scale || e.currentTouch.length > 1) && (J(t), ed(ee.Pan, e));
                           })
                           .on("swipe", (e) => {
                              !(!T() || j()) && M.scale > 1 && ed(ee.Swipe, e);
                           })
                           .on("tap", (e) => {
                              C("click", e);
                           })
                           ...
                           .on("pinch", (e) => {
                              j() || (e.scale > W() ? ed(ee.ZoomIn, e) : e.scale < W() ? ed(ee.ZoomOut, e) : ed(ee.Pan, e));
                           })
                           .on("end", (e) => {
                              j() || (e.currentTouch.length ? (e.srcEvent.stopPropagation(), J(e.srcEvent), g?.end()) : (eu(), ec(), C("touchEnd")));
                           })
                           .init());
                  })(),
                  d &&
                     (d.addEventListener("wheel", R, { passive: !1 }),
                     L.push(() => {
                        d?.removeEventListener("wheel", R, { passive: !1 });
                     })),
                  e?.addEventListener("click", A),
                  document?.addEventListener("mousemove", O),
                  L.push(() => {
                     e?.removeEventListener("click", A), document?.removeEventListener("mousemove", O);
                  });
               let o = I();
               (x = { ...o }),
                  (M = { ...o }),
            ...
            function I() {
               let e = { ...(S("startPos") || {}) },
                  t = e.scale,
                  n = 1;
               n = "string" == typeof t ? q(t) : "number" == typeof t ? t : W();
               let o = { ...en, ...e, scale: n },
                  i = j() ? N(n) : void 0;
               if (i) {
                  let { x: e, y: t } = i;
            ...
            function F() {
               ...
               if (i) {
                  ...
                  M.angle % 180 == 90 ? ((e.top = t.top + 0.5 * t.height - 0.5 * t.width), (e.left = t.left + 0.5 * t.width - 0.5 * t.height), (e.width = t.height), (e.height = t.width)) : ((e.top = t.top), (e.left = t.left), (e.width = t.width), (e.height = t.height));
               }
               return e;
            }
            function _() {
            ...
            function j() {
               return "mousemove" === S("panMode") && matchMedia("(hover: hover)").matches;
            }
            function N(e) {
               let t = v || S("event"),
            ...
            function es(t) {
               ...
               let i = F(),
                  ...
                  a = i.width,
                  s = i.height,
                  c = (t = void 0 === t ? M.scale : t),
                  u = t;
               if (j() && t > 1) {
                  let e = S("mouseMoveFactor");
                  e > 1 && (a * t > l + 0.01 && (c *= e), s * t > r + 0.01 && (u *= e));
               }
               return (a *= c), (s *= u), t > 1 && (a > l && ((n.x[0] = (l - a) * 0.5), (n.x[1] = (a - l) * 0.5)), (n.x[0] -= (i.left - o.left) * 0.5), (n.x[1] -= (i.left - o.left) * 0.5), (n.x[0] -= (i.left + i.width - o.right) * 0.5), (n.x[1] -= (i.left + i.width - o.right) * 0.5), s > r && ((n.y[0] = (r - s) * 0.5), (n.y[1] = (s - r) * 0.5)), (n.y[0] -= (i.top - o.top) * 0.5), (n.y[1] -= (i.top - o.top) * 0.5), (n.y[0] -= (i.top + i.height - o.bottom) * 0.5), (n.y[1] -= (i.top + i.height - o.bottom) * 0.5)), n;
            }
            function ec() {
               if (!T() || !S("bounds") || !g) return;
               let e = B(),
                  t = et(),
                  n = m(e, M.scale, t);
               if (M.scale < e - 0.01 || M.scale > t + 0.01) return void ed(ee.ZoomTo, { scale: n });
               if (g.isRunning() || eE()) return;
               let o = es(n);
               M.x < o.x[0] || M.x > o.x[1] || M.y < o.y[0] || M.y > o.y[1] ? ((M.x = m(o.x[0], M.x, o.x[1])), (M.y = m(o.y[0], M.y, o.y[1])), g.spring({ tension: 170, friction: 17, restDelta: 0.001, restSpeed: 0.001, maxSpeed: 1 / 0, velocity: g.getCurrentVelocities() }), g.from(x).to(M).start()) : ef();
            }
            function eu(t) {
               if (!T()) return;
               let n = eb(),
                  ...
                  a = em(),
                  s = ep();
               U(i, "is-fullsize", r), U(i, "is-expanded", l), U(i, "is-dragging", o), U(i, "can-drag", n), U(i, "will-zoom-in", a), U(i, "will-zoom-out", s);
               let c = ev(),
                  u = ey(),
                  d = eh(),
                  f = !T();
            ...
            function ed(t, n) {
               if (!e || !l || !g || (t === ee.Swipe && Math.abs(g.getCurrentVelocities().scale) > 0.01)) return;
               let o = { ...M },
                  i = { ...M },
                  r = es(j() ? o.scale : x.scale),
               ...
               switch (t) {
                  ...
                  case ee.MoveDown:
                     if (eE()) {
                        let e = 1,
                           t = 1;
                        i.x <= r.x[0] && u <= 0 && (e = 0.2 * Math.max(0.01, 1 - Math.abs((1 / s.width) * Math.abs(i.x - r.x[0])))), i.x >= r.x[1] && u >= 0 && (e = 0.2 * Math.max(0.01, 1 - Math.abs((1 / s.width) * Math.abs(i.x - r.x[1])))), i.y <= r.y[0] && d <= 0 && (t = 0.2 * Math.max(0.01, 1 - Math.abs((1 / s.height) * Math.abs(i.y - r.y[0])))), i.y >= r.y[1] && d >= 0 && (t = 0.2 * Math.max(0.01, 1 - Math.abs((1 / s.height) * Math.abs(i.y - r.y[1])))), (i.x += p * e), (i.y += h * t);
                     } else (i.x = m(r.x[0], i.x + p, r.x[1])), (i.y = m(r.y[0], i.y + h, r.y[1]));
                     break;
                  case ee.Swipe:
                     let b = (e = 0) => Math.sign(e) * Math.pow(Math.abs(e), 1.5);
                     (i.x += m(-1e3, b(u), 1e3)), (i.y += m(-1e3, b(d), 1e3)), d && !u && (i.x = m(r.x[0], i.x, r.x[1])), !d && u && (i.y = m(r.y[0], i.y, r.y[1])), (a.x = u), (a.y = d);
                     break;
                  case ee.ZoomTo:
                     i.scale = n.scale || 1;
                     break;
                  case ee.ZoomIn:
                     (i.scale = i.scale * (n.scale || 2)), c || (i.scale = Math.min(i.scale, et()));
                     break;
                  case ee.ZoomOut:
                  ...
                  case ee.Zoom:
                     let E = Y();
                     i.scale >= E - 0.05 ? (i.scale = W()) : (i.scale = Math.min(E, i.scale * (n.scale || 2)));
                     break;
                  case ee.RotateCW:
                     i.angle += 90;
                     break;
               ...
               if ((void 0 !== x.angle && Math.abs(x.angle) >= 360 && ((i.angle -= 360 * Math.floor(x.angle / 360)), (x.angle -= 360 * Math.floor(x.angle / 360))), v.length)) {
                  let e = v.findIndex((e) => e > i.scale + 1 / K);
                  i.scale = v[e] || v[0];
               }
               if ((c && (i.scale = m(B() * (c ? 0.8 : 1), i.scale, et() * (c ? 1.6 : 1))), j())) {
                  let e = N(i.scale);
                  if (e) {
                     let { x: t, y: n } = e;
                     (i.x = t), (i.y = n);
                  ...
                  let u = (l - o.x) / o.scale,
                     d = (a - o.y) / o.scale;
                  (i.x = l - u * i.scale), (i.y = a - d * i.scale), !c && S("bounds") && ((r = es(i.scale)), (i.x = m(r.x[0], i.x, r.x[1])), (i.y = m(r.y[0], i.y, r.y[1])));
               }
               if (t === ee.Swipe) {
                  let e = 500 * i.scale;
                  g.spring({ tension: 94, friction: 17, maxSpeed: e, restDelta: 0.1, restSpeed: 0.1, velocity: a });
               } else t === ee.Pan || c ? g.spring({ tension: 900, friction: 17, restDelta: 0.01, restSpeed: 0.01, maxSpeed: 1 }) : g.spring({ tension: 170, friction: 17, restDelta: 0.001, restSpeed: 0.001, maxSpeed: 1 / 0, velocity: a });
               if (0 === n.velocity || y(x, i)) (x = { ...i }), (M = { ...i }), g.end(), ef(), eu();
               else {
                  if (y(M, i)) return;
                  g.from(x).to(i).start();
               }
            ...
            function ef() {
               ...
               let {
                     ...
                     let { x: l, y: r, scale: a, angle: s, flipX: c, flipY: u } = x,
                        d = 1 / Y(),
                        f = t,
                        g = n,
                        m = x.scale * d,
                        ...
                        h = Math.max(o, i),
                        v = Math.min(o, i);
                     t > n ? ((f = h), (g = v)) : ((f = v), (g = h)), (m = t > n ? (h * a) / t || 1 : (h * a) / n || 1);
                     let y = f ? t * p : 0,
                        b = g ? n * p : 0,
                        E = f && g ? (t * m) / y : 0;
                     return { x: (l = l + 0.5 * f - 0.5 * y), y: (r = r + 0.5 * g - 0.5 * b), width: y, height: b, scale: E, flipX: c, flipY: u, angle: s, fitWidth: o, fitHeight: i, fullWidth: t, fullHeight: n };
                  })(),
                  m = `translate(${Q(o)}px, ${Q(r)}px)`;
               1 !== f || 1 !== g ? (m += ` scaleX(${Q(c * f)}) scaleY(${Q(c * g)})`) : (m += ` scale(${Q(c)})`), 0 !== u && (m += ` rotate(${u}deg)`), (d.style.width = `${Q(a)}px`), (d.style.height = `${Q(s)}px`), (d.style.transform = `${m}`), C("render");
            }
            function eg() {
               let e = M.scale,
                  t = void 0,
            ...
            let eS = {
               ...
               canZoomToFull: ey,
               destroy: function () {
                  for (let e of (C("destroy"), Object.values(w))) e?.destroy(eS);
                  for (let e of L) e();
                  return i && ((i.style.aspectRatio = ""), (i.style.maxWidth = ""), (i.style.maxHeight = "")), d && ((d.style.width = ""), (d.style.height = ""), (d.style.transform = "")), (i = void 0), (l = void 0), (d = void 0), (x = { ...en }), (M = { ...en }), g?.destroy(), (g = void 0), f?.destroy(), (f = void 0), (b = eo.Destroyed), eS;
               },
               emit: C,
               execute: ed,
               getBoundaries: es,
               ...
               init: function () {
                  return (
                     ...
                     (function () {
                        if (!e || !l) return;
                        if (!(l instanceof HTMLImageElement && c instanceof HTMLImageElement)) return k();
                        let t = () => {
                           l &&
                        ...
                        if (((b = eo.Loading), e.classList.add("is-loading"), C("loading"), c.src && c.complete)) return t();
                        (function () {
                           if (!e || e?.querySelector(".f-spinner")) return;
                           let t = s(S("spinnerTpl"));
               ...
               off: function (e, t) {
                  for (let n of e instanceof Array ? e : [e])
                     P.has(n) &&
                        P.set(
                           n,
                           P.get(n).filter((e) => e !== t)
                        );
                  return eS;
               },
               on: function (e, t) {
                  for (let n of e instanceof Array ? e : [e]) P.set(n, [...(P.get(n) || []), t]);
                  return eS;
               },
               toggleFS: eM,
               updateControls: eu,
      ...
      let ec = (e, t) => {
         ...
         ef = (((C = {})[(C.Init = 0)] = "Init"), (C[(C.Ready = 1)] = "Ready"), (C[(C.Destroyed = 2)] = "Destroyed"), C),
         eg = (((R = {})[(R.Loading = 0)] = "Loading"), (R[(R.Loaded = 1)] = "Loaded"), (R[(R.Error = 2)] = "Error"), R),
         em = { adaptiveHeight: !1, center: !0, classes: { container: "f-carousel", isEnabled: "is-enabled", isLTR: "is-ltr", isRTL: "is-rtl", isHorizontal: "is-horizontal", isVertical: "is-vertical", hasAdaptiveHeight: "has-adaptive-height", viewport: "f-carousel__viewport", slide: "f-carousel__slide", isSelected: "is-selected" }, dragFree: !1, enabled: !0, errorTpl: '<div class="f-html">{{ERROR}}</div>', fill: !1, infinite: !0, initialPage: 0, l10n: eu, rtl: !1, slides: [], slidesPerPage: "auto", spinnerTpl: '<div class="f-spinner"></div>', transition: "fade", tween: { clamp: !0, mass: 1, tension: 160, friction: 25, restDelta: 1, restSpeed: 1, velocity: 0 }, vertical: !1 },
         ep = 0,
         eh = (e, t = {}, o = {}) => {
            let i, c, d, g, v;
            ep++;
            ...
            function K(e, ...t) {
               let n = [...(Y.get(e) || [])];
               for (let o of (E.on && n.push(E.on[e]), n)) o && o instanceof Function && o(ek, ...t);
               "*" !== e && K("*", e, ...t);
            }
            function J() {
               let e = f({}, em, b);
                  ...
                  eA(),
                     !1 !== (E = e).enabled &&
                        ...
                        (function () {
                           ...
                           (M = x.querySelector(`.${e.viewport}`)) || (h((M = document.createElement("div")), e.viewport), M.append(...ec(x, `.${e.slide}`)), x.insertAdjacentElement("afterbegin", M)), (x.carousel = ek), K("initLayout");
                        })(),
                        (function () {
                           if (!M) return;
                           let e = W("classes") || {};
                           ...
                           [...ec(M, `.${e.slide}`)].forEach((e) => {
                              e.parentElement && _.push(eg({ el: e, isVirtual: !1, ...(e.dataset || {}) }));
                           }),
                           eu(W("slides")),
                           _))
                              K("addSlide", t);
                           for (let e of _) {
                              let t = e.el;
                              t?.parentElement && (h(t, E.classes.slide), h(t, e.class), eP(e), K("attachSlideEl", e));
                           }
                           K("initSlides");
                        })(),
                        eE(),
                        (function () {
                           if (x && (x.addEventListener("click", eL, { passive: !1 }), document.addEventListener("mousemove", Q), !d)) {
                              let e = null;
                                    ...
                                    (e = requestAnimationFrame(() => {
                                       (function (e) {
                                          ...
                                          let n = x.getBoundingClientRect(),
                                             o = n.height,
                                             l = n.width;
                                          if (!(t > 1 && ((P && 0.5 > Math.abs(o - N)) || (!P && 0.5 > Math.abs(l - q))))) (N = o), (q = l), (!P || o) && (P || l) && x && M && ((t === j.length && i?.isPointerDown()) || (W("dragFree") && (S || (R > k && R < I)) ? (en(), eR()) : eC(O, { transition: !1 })));
                                       })(t),
                                          (e = null);
                                    }));
                              })).observe(x);
                  ...
                  (i = G(M, e)
                     ...
                     .on("move", (e) => {
                        let { srcEvent: t, axis: n } = e,
                           o = e.srcEvent.target;
                        (o && u(o)) || (n || (t.stopPropagation(), t.stopImmediatePropagation()), (("y" === n && P) || ("x" === n && !P)) && (ed(t), t.stopPropagation()));
                     })
                     .on("panstart", (e) => {
                     ...
                     .on("pan", (e) => {
                        ...
                        if (!c || o.length > 1 || ("y" === i && !P) || ("x" === i && P)) return;
                        let l = T && !P ? 1 : -1,
                           r = P ? n : t,
                           a = c?.isRunning() ? c.getEndValues().pos : R,
                           s = 1;
                        !S && (a <= k && r * l < 0 ? (s = 0.2 * Math.max(0.01, 1 - Math.abs((1 / er()) * Math.abs(a - k)))) : a >= I && r * l > 0 && (s = 0.2 * Math.max(0.01, 1 - Math.abs((1 / er()) * Math.abs(a - I))))),
                           (a += r * s * l),
                           c
                     ...
                     .on("end", (e) => {
                        ...
                        let a = W("vertical") ? o : n,
                           ...
                           u = T && !P ? 1 : -1;
                        if (((s += a * (r ? 5 : 1) * u), !S && ((a * u <= 0 && s < k) || (a * u >= 0 && s > I)))) {
                           let e = 0;
                           Math.abs(a) > 0 && ((e = 2 * Math.abs(a)), (e = Math.min(0.3 * er(), e))),
                              (s = m(k + -1 * e, s, I + e)),
                              c
                                 .spring({ clamp: !0, mass: 1, tension: 380, friction: 25, velocity: -1 * a, restDelta: 1, restSpeed: 1 })
                                 .from({ pos: R })
                                 .to({ pos: s })
                                 .start();
                           return;
                        ...
                        if (r || w.Autoscroll?.isEnabled())
                           return void (Math.abs(a) > 10
                              ? c
                                   .spring({ clamp: !0, mass: 1, tension: 150, friction: 25, velocity: -1 * a, restDelta: 1, restSpeed: 1 })
                                   .from({ pos: R })
                                   .to({ pos: s })
                                   .start()
                              : c.isRunning() || A || ((A = !0), K("settle")));
                        if (!(r || w.Autoscroll?.isEnabled()) && (!(e.offsetX || e.offsetY) || ("y" === t && !P) || ("x" === t && P))) return void eC(O, { transition: "tween" });
                        let d = el(s);
                        Math.abs(a) > 10 && d === O && (a > 0 ? (d += T && !P ? 1 : -1) : (d += T && !P ? -1 : 1)), eC(d, { transition: "tween", tween: { velocity: -1 * a } });
                     })
                     .init());
            }
            function et(e = "*") {
            ...
            function eo() {
               if (!x) return;
               for (let e of (U(M, "is-draggable", !!i && j.length > 0), x.querySelectorAll("[data-carousel-index]"))) e.innerHTML = O + "";
               for (let e of x.querySelectorAll("[data-carousel-page]")) e.innerHTML = O + 1 + "";
               for (let e of x.querySelectorAll("[data-carousel-pages]")) e.innerHTML = j.length + "";
               for (let e of x.querySelectorAll("[data-carousel-go-prev]")) e.toggleAttribute("aria-disabled", !eO()), eO() ? e.removeAttribute("tabindex") : e.setAttribute("tabindex", "-1");
               for (let e of x.querySelectorAll("[data-carousel-go-next]")) e.toggleAttribute("aria-disabled", !ez()), ez() ? e.removeAttribute("tabindex") : e.setAttribute("tabindex", "-1");
               let e = !1,
                  t = j[O]?.slides[0];
            ...
            function el(e) {
               ...
               let t = ea(),
                  n = e;
               S ? (n -= Math.floor((e - j[0]?.pos) / t) * t) : (n = m(j[0]?.pos, e, j[j.length - 1]?.pos));
               let o = new Map(),
                  i = 0;
               for (let e of j) {
               ...
               return parseInt((o.size > 0 ? [...o.entries()].reduce((e, t) => (t[1] < e[1] ? t : e)) : [O, 0])[0]);
            }
            function er() {
               return (M && M.getBoundingClientRect()[C]) || 0;
            }
            function ea(e = !0) {
               return H.reduce((e, t) => e + t.dim, 0) + (H.length - (S && e ? 0 : 1)) * B;
            }
            function es(e) {
               let t = ea(),
                  n = er();
               ...
               for (let a of H) {
                  let s = (t = 0) => {
                     !(o.indexOf(a) > -1) && ((a.pos = r - e + t || 0), a.offset + t > e - a.dim - i + 0.51 && a.offset + t < e + n + l - 0.51 && o.push(a));
                  };
            ...
            function eg(e) {
               return (r(e) || e instanceof HTMLElement) && (e = { html: e }), { index: -1, el: void 0, class: "", isVirtual: !0, dim: 0, pos: 0, offset: 0, html: "", src: "", ...e };
            }
            function ev(e) {
               if (!M || !e) return;
               let t = e.el;
               if (t) {
                  if ((t.setAttribute("index", e.index + ""), t.parentElement !== M)) {
                     ...
                     M.insertBefore(t, n && M.contains(n) ? n : null), K("attachSlideEl", e);
                  }
                  return ei(e), t;
               }
            }
            ...
            function eE() {
               ...
               let e = W("classes");
               U(x, e.isLTR, !T), U(x, e.isRTL, T), U(x, e.isHorizontal, !P), U(x, e.isVertical, P), U(x, e.hasAdaptiveHeight, W("adaptiveHeight")), (L = "visible" === window.getComputedStyle(M).getPropertyValue("overflow-" + (P ? "y" : "x")));
               let t = M.getBoundingClientRect();
               if (!t.width && !t.height) return;
               B = (M && parseFloat(getComputedStyle(M).getPropertyValue("--f-carousel-gap"))) || 0;
               let n = (function () {
                  let e = 0;
                  if (M) {
                     let t = document.createElement("div");
                     h(t, E.classes.slide), M.appendChild(t), (e = t.getBoundingClientRect()[C]), t.remove(), (t = void 0);
                  }
                  return e;
               })();
               for (let e of H) {
                  ...
                  if (!e.isVirtual && t && a(t)) {
                     let e = !1;
                     (t.parentElement && t.parentElement === M) || (M.appendChild(t), (e = !0)), (o = t.getBoundingClientRect()[C]), e && t.parentElement?.removeChild(t);
                  } else o = n;
                  e.dim = o;
               }
               if (((S = !1), W("infinite"))) {
               ...
               if (
                  (!(function () {
                     ...
                     let i = 0,
                        l = 0;
                     for (let e of H) (!j.length || i + e.dim - t > 0.05 || l >= o) && (j.push({ index: j.length, slides: [], dim: 0, offset: 0, pos: 0 }), (i = 0), (l = 0)), j[j.length - 1]?.slides.push(e), (i += e.dim + B), l++;
                     let r = W("center"),
                        a = W("fill"),
                        s = 0;
                     for (let e of j) {
                        for (let t of ((e.dim = (e.slides.length - 1) * B), e.slides)) e.dim += t.dim;
                        (e.offset = s), (e.pos = s), !1 !== r && (e.pos -= (t - e.dim) * 0.5), a && !S && n > t && (e.pos = m(0, e.pos, n - t)), (s += e.dim + B);
                     }
                     let c = [];
                     for (let t of j) {
                        let n = { ...t };
                  ...
                  void 0 !== e && (O = ek.getPageIndex(e) || 0), (O = m(0, O, j.length - 1)), (z = R = j[O]?.pos || 0);
               } else {
                  let e = c?.isRunning() ? c.getEndValues().pos : R;
                  (e < k || e > I) && ((O = m(0, O, j.length - 1)), (z = j[O || 0]?.pos || 0));
               }
               K("refresh");
            }
            function ew(e) {
               ...
               e.removeEventListener("animationend", eM), X(e, o.join(" ")), D.delete(t);
            }
            function ex() {
               if (!M) return;
               let e = D.size;
               for (let e of H) ew(e.el);
               D.clear(), e && eR();
            }
            function eM(e) {
               "f-" === e.animationName.substring(0, 2) && (ew(e.target), !D.size && (X(x, "in-transition"), !A && 0.5 > Math.abs(ek.getPosition(!0) - z) && ((A = !0), K("settle"))), eR());
            }
            function eL(e) {
            ...
            function eT(e) {
               let t = e.el;
               t && (t.querySelector(".f-html.is-error")?.remove(), X(t, "has-error"));
            }
            function eP(e) {
               e || (e = j[O]?.slides[0]);
               let t = e?.el;
               ...
               !i && n instanceof HTMLElement && n.classList.contains("f-caption") && (i = n), !i && (h((i = document.createElement("div")), "f-caption"), r(n) ? (i.innerHTML = Z(n + "")) : n instanceof HTMLElement && (n.parentElement && (n = n.cloneNode(!0)), i.append(n)));
            ...
            function eC(e, t = {}) {
               ...
               if (
                  !i ||
                  (function (e, t) {
                     if (!x || !c || !t || !r(t) || "tween" === t || j[O]?.slides.length > 1) return !1;
                     let n = j.length,
                        o = e > O ? 1 : -1;
                     ...
                     let i = j[O]?.slides[0],
                        ...
                        s = a?.index,
                        u = j[e]?.pos;
                     if (void 0 === s || void 0 === l || l === s || R === u || Math.abs(er() - (a?.dim || 0)) > 1) return !1;
                     (A = !1), c.pause(), ex(), h(x, "in-transition"), (R = z = u);
                     let d = ev(i),
                        f = ev(a);
                     return en(), d && (D.add(l), (d.style.transform = ""), d.addEventListener("animationend", eM), X(d, E.classes.isSelected), (d.inert = !1), h(d, `f-${t}Out to-${o > 0 ? "next" : "prev"}`)), f && (D.add(s), (f.style.transform = ""), f.addEventListener("animationend", eM), h(f, E.classes.isSelected), (f.inert = !1), h(f, `f-${t}In from-${o > 0 ? "prev" : "next"}`)), eR(), !0;
                  })(e, n)
               )
                  return;
               (e = S ? ((e % i) + i) % i : m(0, e, i - 1)), (z = j[e || 0]?.pos || 0);
               let a = c.isRunning() ? c.getEndValues().pos : R;
               if (1 > Math.abs(z - a)) {
                  (R = z), O !== e && (eP(), eo(), ei(), (g = O), K("change", (O = e), g)), eR(), A || ((A = !0), K("settle"));
                  return;
               }
               if ((c.pause(), ex(), S)) {
                  let e = ea(),
               ...
               if (!1 !== n && l(o)) return void c.spring(f({}, E.tween, o)).from({ pos: R }).to({ pos: z }).start();
            ...
            function eR() {
               ...
               let n = new Set(),
                  o = [];
               for (let i of H) {
                  if (i.isVirtual && !D.has(i.index) && 0 > V.indexOf(i)) continue;
                  let l = ev(i);
                  if (!l) continue;
                  o.push(i);
               ...
               M && e && (M.style.height = `${e}px`),
                  [...ec(M, `.${E.classes.slide}`)].forEach((e) => {
                     ...
                     t || e.remove();
                     let o = n.has(e);
                     if ((U(e, E.classes.isSelected, o), (e.inert = 0 > V.indexOf(t)), t.isVirtual && !D.has(t.index) && 0 > V.indexOf(t))) return void ey(t);
                     ...
                     D.has(t.index) || ((l = P ? 0 : T ? -1 * i : i), (r = P ? i : 0), (a = p(l, 0, t.dim, 0, 100)), (s = p(r, 0, t.dim, 0, 100))), c instanceof Function && !D.has(t.index) ? c(ek, t, { x: l, y: r, xPercent: a, yPercent: s }) : (e.style.transform = l || r ? `translate3d(${a}%, ${s}%,0)` : "");
                  }),
                  K("render", o);
            }
            function eA() {
               for (let e of (x?.removeEventListener("click", eL), ex(), document.removeEventListener("mousemove", Q), d?.disconnect(), (d = void 0), _)) e.el && a(e.el) && ((e.state = void 0), eS(e), eT(e), ey(e), e.isVirtual ? (e.el?.remove(), (e.el = void 0)) : ((e.el.style.transform = ""), M?.appendChild(e.el)));
               for (let e of Object.values(w)) e?.destroy();
               for (let [e, t] of ((w = {}), i?.destroy(), (i = void 0), c?.destroy(), (c = void 0), Object.entries(E.classes || {}))) "container" !== e && X(x, t);
               X(M, "is-draggable");
            }
            function eO() {
               return S || O > 0;
            ...
            let ek = {
               add: function (e, t) {
                  let n = R,
                     o = O,
                     i = ea(),
                     l = Math.floor(((c?.isRunning() ? c.getEndValues().pos : R) - j[0]?.pos) / i);
                  for (let n of eu(e, t)) K("addSlide", n);
                  return et(F), eE(), c && (o === O && (n -= l * i), n === (z = j[O || 0]?.pos || 0) ? (R = z) : c.spring({ clamp: !0, mass: 1, tension: 300, friction: 25, restDelta: 1, restSpeed: 1 }).from({ pos: n }).to({ pos: z }).start()), eR(), ek;
               },
               canGoPrev: eO,
               canGoNext: ez,
               destroy: function () {
                  return K("destroy"), window.removeEventListener("resize", J), eA(), Y.clear(), (x = null), (j = []), (_ = []), (E = { ...em }), (w = {}), (H = []), (v = ""), (F = "*"), (y = ef.Destroyed), ek;
               },
               emit: K,
               filter: function (e = "*") {
               ...
               init: function () {
                  ...
                  return y !== ef.Init && (eA(), (y = ef.Init)), (x = e), (b = t), window.removeEventListener("resize", J), b.breakpoints && window.addEventListener("resize", J), J(), ek;
               },
               isInfinite: function () {
                  return S;
               },
               ...
               on: function (e, t) {
                  for (let n of e instanceof Array ? e : [e]) Y.set(n, [...(Y.get(n) || []), t]);
                  return ek;
               },
               prev: function (e = {}) {
                  return eC(O - 1, e), ek;
               ...
               remove: function (e) {
                  ...
                  let t = _[e];
                  return t && (K("removeSlide", t), t.el && (ew(t.el), t.el.remove(), (t.el = void 0)), _.splice(e, 1), et(F), eE(), eR()), ek;
               },
               ...
               showError: function (e, t) {
                  ...
                  if (n) {
                     ...
                     h(o, "f-html"), h(o, "is-error"), (o.innerHTML = Z(t || "<p>{{ERROR}}</p>")), (e.htmlEl = o), h(n, "has-html"), h(n, "has-error"), n.insertAdjacentElement("afterbegin", o), K("contentReady", e);
                  }
                  return ek;
               },
               showLoading: function (e) {
                  ...
                  return o && (h(o, "f-spinner"), t.insertAdjacentElement("beforeend", o)), ek;
               },
               version: "6.0.32",
            };
            return ek;
    ...
    data-lazy-src="{{src}}" alt="{{alt}}" />`,
         ...
         eb = () => {
            ...
            function n() {
               e && (e.on("addSlide", a), e.on("removeSlide", s), e.on("attachSlideEl", c), e.on("click", i), e.on("change", o), e.on("ready", o));
            }
            function o() {
               u();
               ...
               if (t.length > 1 || e?.getOption("transition") === "slide")
                  for (let n of t) {
                     let t = n.panzoomRef;
                     t && 0 > (e?.getPage().slides || []).indexOf(n) && t.execute(ee.ZoomTo, { ...t.getStartPosition() });
                  }
            }
            function i(e, t) {
               let n = t.target;
            ...
            function a(n, o) {
               ...
               if (l && r(l) && !o.html && (!o.type || "image" === o.type)) {
                  ...
                  let e = t("tpl", o);
                  (e = ev(e, "{{src}}", l + "")), (e = ev(e, "{{alt}}", a + "")), (e = ev(e, "{{srcset}}", s + "")), (e = ev(e, "{{sizes}}", c + "")), i.insertAdjacentHTML("afterbegin", e);
               }
               if (!i.querySelector(".f-panzoom__content")) return;
               let d = es(i, { width: o.width && "auto" !== o.width ? parseFloat(o.width + "") : "auto", height: o.height && "auto" !== o.height ? parseFloat(o.height + "") : "auto", classes: { container: "f-zoomable" }, event: () => e?.getLastMouseMove(), spinnerTpl: () => e?.getOption("spinnerTpl") || "", ...t("Panzoom") });
               d.on("*", (t, n, ...i) => {
            ...
            return {
               ...
               destroy: function () {
                  if (e) for (let t of (e.off("addSlide", a), e.off("removeSlide", s), e.off("attachSlideEl", c), e.off("click", i), e.off("change", o), e.off("ready", o), e.getSlides())) s(e, t);
                  e = void 0;
               },
               execute: d,
            };
         ...
         ew = () => {
            ...
            function o() {
               let o = n().target;
               e && o && e && o && ((t = o), (e.getOptions().classes = { ...e.getOptions().classes, isSelected: "" }), (e.getOptions().initialSlide = t.getPage()?.slides[0]?.index || 0), n().syncOnChange && e.on("change", r), n().syncOnClick && e.on("click", s), n().syncOnHover && e.getViewport()?.addEventListener("mouseover", c), e && t && (e.on("ready", i), e.on("refresh", u), t.on("change", a), t.on("filter", d)));
            }
            function i() {
               f();
            }
                           ...
                           if (s && u) {
                              ...
                              t().showLoading && e?.showLoading(n),
                                 ...
                                 r.addEventListener("error", () => {
                                    e?.hideLoading(n), r.classList.remove(eM), r.classList.add("has-lazyerror"), a || e?.emit("lazyLoad:error", n, r, u);
                                 }),
            ...
            function a() {
               e && !1 !== e.getOptions().Arrows && e.getPages().length > 1
                  ? (!(function () {
                       if (!e) return;
                       let o = e.getViewport();
                       o && (!t && (t = i("prev")) && o.insertAdjacentElement("beforebegin", t), !n && (n = i("next")) && o.insertAdjacentElement("afterend", n), U(e.getContainer(), "has-arrows", !!(t || n)));
                    })(),
         ...
         eC = '<circle cx="11" cy="11" r="7.5"/><path d="m21 21-4.35-4.35M8 11h6"/>',
         eR = '<g><line x1="11" y1="8" x2="11" y2="14"></line></g>' + eC,
         eA = {};
      ...
      let eO = (((A = {}).Left = "left"), (A.middle = "middle"), (A.right = "right"), A),
         ez = { counter: { tpl: '<div class="f-counter"><span data-carousel-page></span>/<span data-carousel-pages></span></div>' }, download: { tpl: '<button data-carousel-download class="f-button" title="{{DOWNLOAD}}"><svg><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2M7 11l5 5 5-5M12 4v12"/></svg></button>' }, autoplay: { tpl: '<button data-autoplay-action="toggle" class="f-button" title="{{TOGGLE_AUTOPLAY}}"><svg><g><path d="M5 3.5 19 12 5 20.5Z"/></g><g><path d="M8 4v15M17 4v15"/></g></svg></button>' }, thumbs: { tpl: '<button data-thumbs-action="toggle" class="f-button" title="{{TOGGLE_THUMBS}}"><svg><rect width="18" height="14" x="3" y="3" rx="2"/><path d="M4 21h1M9 21h1M14 21h1M19 21h1"/></svg></button>' }, ...eA },
         ek = { absolute: !1, display: { left: [], middle: ["zoomIn", "zoomOut", "toggle1to1", "rotateCCW", "rotateCW", "flipX", "flipY", "reset"], right: [] }, enabled: "auto", items: {} },
         eI = () => {
            let e, t;
            function n(t) {
            ...
            function o() {
               ...
               for (let n of ["left", "middle", "right"]) {
                  ...
                  for (let t of (i.classList.add("f-carousel__toolbar__column"), i.classList.add(`is-${n}`), o)) {
                     let n;
                     if (r(t)) {
                        if (("counter" === t && !c) || ("autoplay" === t && !m) || (eA[t] && !u) || ("fullscreen" === t && !p) || ("thumbs" === t && !g) || ("download" === t && !d)) continue;
                        n = v[t];
                     }
                     if ((l(t) && (n = t), n && n.tpl)) {
               ...
               if (t.childElementCount) {
                  if ((!0 === a && t.classList.add("is-absolute"), !t.parentElement)) {
                     let o = n("parentEl");
         ...
         eF = { autoStart: !0, pauseOnHover: !0, showProgressbar: !0, timeout: 2e3 },
         e_ = () => {
            let e,
               t,
               n = !1,
            ...
            function u() {
               ...
               (n = !0), e.emit("autoplay:start", a("timeout")), e.getContainer()?.classList.add("has-autoplay"), e.getTween()?.on("start", y);
               let t = e?.getContainer();
               t && a("pauseOnHover") && matchMedia("(hover: hover)").matches && (t.addEventListener("mouseenter", b, !1), t.addEventListener("mouseleave", E, !1)), e.on("change", h), e.on("settle", v), e.on("contentReady", m), e.on("panzoom:touchStart", d), e.on("panzoom:wheel", d), e.isSettled() && c();
            }
            function d() {
               if ((s(), f(), n && e)) {
                  e.emit("autoplay:end"), e.getContainer()?.classList.remove("has-autoplay"), e.getTween()?.off("start", y);
                  let t = e?.getContainer();
                  t && (t.removeEventListener("mouseenter", b, !1), t.removeEventListener("mouseleave", E, !1));
               }
               e && (e.off("change", h), e.off("settle", v), e.off("contentReady", m), e.off("panzoom:touchStart", d), e.off("panzoom:wheel", d)), (n = !1), (o = !1);
            }
            function f() {
               r && (r.remove(), (r = null));
            }
         ...
         eH = () => {
            ...
            function g(e) {
               let t = e.thumb ? (e.thumb instanceof HTMLImageElement ? e.thumb.src : e.thumb) : e.thumbSrc || void 0,
                  ...
                  o = s("thumbTpl");
               return (o = ev(o, "{{alt}}", n)), (o = ev(o, "{{src}}", t + "")), (o = ev(o, "{{index}}", `${e.index}`)), { html: (o = ev(o, "{{page}}", `${e.index || 1}`)), class: e.thumbClass };
            }
            function p() {
               if (!o || !e || !n || t) return;
               let l = [];
               ...
               n?.classList.toggle("is-syncing", e?.hasNavigated() === !1 || e?.getTween()?.isRunning()),
                  ...
                  e?.getGestures()?.isPointerDown() &&
                     (function () {
                        ...
                        if (void 0 === c) return;
                        let d = o[l].pos + s * (i - r);
                        (d = m(o[0].pos, d, o[o.length - 1].pos)), n.from({ pos: c }).to({ pos: d }).start();
                     })();
            }
            function w() {
               a = !0;
         ...
         eD = { iframeAttr: { allow: "autoplay; fullscreen", scrolling: "auto" } },
         eV = () => {
            let e;
            function t(e, t) {
               let n = t.src;
    ...
    <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn't support embedded videos.</video>`,
         ...
         eB = { autoStart: !1, btnTpl: '<button data-fullscreen-action="toggle" class="f-button" title="{{TOGGLE_FULLSCREEN}}"><svg><g><path d="M8 3H5a2 2 0 0 0-2 2v3M21 8V5a2 2 0 0 0-2-2h-3M3 16v3a2 2 0 0 0 2 2h3M16 21h3a2 2 0 0 0 2-2v-3"/></g><g><path d="M15 19v-2a2 2 0 0 1 2-2h2M15 5v2a2 2 0 0 0 2 2h2M5 15h2a2 2 0 0 1 2 2v2M5 9h2a2 2 0 0 0 2-2V5"/></g></svg></button>' },
         eW = "in-fullscreen-mode",
         eZ = () => {
            let e;
            function t(t) {
         ...
         eQ = () => {
            ...
            let { slug: t, index: n } = eK(),
               o = e?.getSlide()?.fancybox || void 0;
            e && o && (t === o ? e.getCarousel()?.goTo(n - 1) : ((eU = !0), e.close(), (eU = !1))), eJ();
         },
         e0 = () => {
            i &&
               setTimeout(() => {
                  (eG = !0), eJ(), (eG = !1), window.addEventListener("hashchange", eQ, !1);
               }, 300);
         },
         e1 = () => {
            let e,
            ...
            function o() {
               ...
               if (!s) return;
               let u = `#${s}-${c}`;
               if ((2 > (e.getCarousel()?.getPages()?.length || 0) && (u = `#${s}`), l !== u && (n = l), history.scrollRestoration && ((t = history.scrollRestoration), (history.scrollRestoration = "manual")), o.on("change", i), !eG))
                  if (s === r)
                     try {
                     ...
                     try {
                        window.history.pushState({}, document.title, window.location.pathname + window.location.search + u), (eY = !0);
                     } catch (e) {}
            }
            function i() {
               if (!e || !e.isTopMost() || !1 === e.getOptions().Hash) return;
            ...
            function l() {
               if (eU || !e || !e.isTopMost() || !1 === e.getOptions().Hash) return;
               let t = e.getSlide();
               if (t && t.fancybox) {
                  eX = !0;
                  try {
      ...
      (e1.startFromUrl = eJ),
         (e1.setup = function (e) {
            !i && ((i = e), g() && (/complete|interactive|loaded/.test(document.readyState) ? e0() : document.addEventListener("DOMContentLoaded", e0)));
         });
      let e2 = { ...eu, CLOSE: "Close", NEXT: "Next", PREV: "Previous", MODAL: "You can close this modal content with the ESC key", ELEMENT_NOT_FOUND: "HTML Element Not Found", IFRAME_ERROR: "Error Loading Page" },
         e5 = '<button class="f-button" title="{{CLOSE}}" data-fancybox-close><svg><path d="M19.286 4.714 4.714 19.286M4.714 4.714l14.572 14.572" /></svg></button>';
      eI().add("close", { tpl: e5 });
      let e4 = (e) => {
         ...
         e6 = (((O = {})[(O.Init = 0)] = "Init"), (O[(O.Ready = 1)] = "Ready"), (O[(O.Closing = 2)] = "Closing"), (O[(O.Destroyed = 3)] = "Destroyed"), O),
         e7 = {
            ajax: null,
            backdropClick: "close",
            Carousel: {},
      ...
      <div class="fancybox__carousel"></div>
         ...
         tt = {
            ...
            bind: function (e, t, n) {
               ...
               let a = tt.openers.get(o) || new Map();
               if ((a.set(i, l), tt.openers.set(o, a), 1 === a.size))
                  for (let e of (o.addEventListener("click", tt.fromEvent), Object.values(tt.Plugins))) {
                     let t = e.setup;
                     "function" == typeof t && t(tt);
                  }
               return !0;
            },
            close: function (e = !0, ...t) {
               if (e) for (let e of e9.values()) e.close(...t);
               else {
                  let e = tt.getInstance();
                  e && e.close(...t);
               }
            },
            destroy: function () {
               let e;
               for (; (e = tt.getInstance()); ) e.destroy();
               for (let e of tt.openers.keys()) e.removeEventListener("click", tt.fromEvent);
               tt.openers.clear();
            },
            fromEvent: function (e) {
               ...
               if (!t || !n) return;
               e.preventDefault();
               let r = f({}, e7, { triggerEvent: e, triggerEl: o, delegateEl: i }, l),
                  a = r.groupAll,
                  s = r.groupAttr,
               ...
               let g = tt.getInstance();
               if (g) {
                  let e = g.getOptions().triggerEl;
                  if (e && u.indexOf(e) > -1) return;
               }
               return { ...(r.Carousel || {}) }.rtl && (u = u.reverse()), o && (r.startIndex = u.indexOf(o)), tt.fromNodes(u, r);
            },
            ...
            fromSelector: function (e, t, n) {
               ...
               let a = tt.openers.get(o);
               if (a && (l = f({}, a.get(i) || {}, l))) return tt.fromNodes(Array.from(o.querySelectorAll(i)), l);
            },
            getCarousel: function () {
               return tt.getInstance()?.getCarousel() || void 0;
            },
            ...
            getInstance: function (e) {
               if (e) {
                  let t = e9.get(e);
                  return t && t.getState() !== e6.Destroyed ? t : void 0;
               }
               return (
                  Array.from(e9.values())
                     .reverse()
                     .find((e) => {
                        if (e.getState() !== e6.Destroyed) return e;
                     }) || void 0
               );
            },
            getSlide: function () {
               return tt.getInstance()?.getSlide() || void 0;
            },
            show: function (e = [], t = {}) {
               return (() => {
                  let e,
                        ...
                        "ajax" === n.type &&
                           (function (t) {
                              ...
                              o.onreadystatechange = function () {
                                 if (o.readyState === XMLHttpRequest.DONE && g === e6.Ready)
                  ...
                  function A(e) {
                     ...
                     let t = e.composedPath()[0];
                     t.closest(".fancybox__carousel") && t.classList.contains("fancybox__slide") && H(e);
                  }
                  function O() {
                        ...
                        (function () {
                           ...
                           let o = 0,
                              ...
                              r = $().on("step", (t) => {
                                 ...
                                 let n = e?.getViewport();
                                 if (i && n) {
                                    let e = p(Math.abs(o), 0, 0.5 * n.getBoundingClientRect().height, 1, 0.5);
                           ...
                           n.on("start", function () {
                              ...
                              .on("pan", function (t) {
                                 let n = t.srcEvent.target;
                                 !(n && u(n)) && e?.getViewport() && "y" === t.axis && ((l += t.deltaY), r.spring({ clamp: !0, mass: 1, tension: 860, friction: 17, restDelta: 0.01, restSpeed: 0.01 }).from({ y: o }).to({ y: l }).start());
                              })
                              .on("end", function (e) {
                                 r.pause(),
                                    ("y" === e.axis && Math.abs(e.velocityY) > 5 && Math.abs(l) > 0 && (eo(e.srcEvent, "f-throwOut" + (e.velocityY > 0 ? "Down" : "Up")), g === e6.Closing)) ||
                                       (0 !== o &&
                                          ((l = 0),
                                          r
                  ...
                  function F() {
                     ...
                     U(i, "has-thumbs", t?.isEnabled() || !1), U(i, "has-vertical-thumbs", t?.getCarousel()?.isVertical() || !1);
                  }
                  function _() {
                     if (i) {
                        let t = e?.getPages() || [],
                           n = e?.getPageIndex() || 0;
                        for (let e of i.querySelectorAll("[data-fancybox-index]")) e.innerHTML = n + "";
                        for (let e of i.querySelectorAll("[data-fancybox-page]")) e.innerHTML = n + 1 + "";
                        for (let e of i.querySelectorAll("[data-fancybox-pages]")) e.innerHTML = t.length + "";
                     }
                  }
                  function H(e) {
                     if (e.composedPath()[0].closest("[data-fancybox-close]")) return void eo(e);
                     T("backdropClick", e), !e.defaultPrevented && M("backdropClick") && eo(e);
                  }
                  function D() {
                     ee();
                  }
                  function V(t) {
                     if (!B() || g !== e6.Ready) return;
                     let n = t.key,
                        o = M("keyboard");
                  ...
                  function j(e) {
                     if (!B() || g !== e6.Ready || (ee(), e.defaultPrevented)) return;
                     let t = e.composedPath()[0],
                  ...
                  function q(t) {
                     ...
                     if (n && o && i) {
                        ...
                        o.spring({ tension: 215, friction: 25, restDelta: 0.001, restSpeed: 0.001, maxSpeed: 1 / 0 })
                           .from(i)
                           .to({ x: e, y: t, scale: l })
                           .start();
                        return;
                     ...
                     l && e3(l, M("showClass", t));
                  }
                  function B() {
                     return tt.getInstance()?.getId() === v;
                  }
                  function W() {
                     return e?.getPage()?.slides[0];
                  }
                  ...
                  function K() {
                     n && clearTimeout(n), (n = void 0), document.removeEventListener("mousemove", D);
                  }
                  function J() {
                     if (E || n) return;
                     let e = M("idle");
                  ...
                  function Q() {
                     i && (K(), h(i, "is-idle"), document.addEventListener("mousemove", D), (E = !0));
                  }
                  function ee() {
                     E && (et(), J());
                  }
                  ...
                  function eo(n, o) {
                     if (g === e6.Closing || g === e6.Destroyed) return;
                  ...
                  function ei(t, n) {
                     if (g !== e6.Closing) return;
                     if ((T("close", t), document.body.removeEventListener("click", j), document.body.removeEventListener("keydown", V, { passive: !1, capture: !0 }), M("placeFocusBack"))) {
                        var o;
                        let e = Z();
                  ...
                  function el() {
                     ...
                     if (((y = {}), o?.remove(), (o = void 0), (i = void 0), (e = void 0), e9.delete(v), !e9.size && (d(!1), document.documentElement.classList.remove(te), M("placeFocusBack"))))
                        try {
                  ...
                  let er = {
                     ...
                     init: function (t = [], n = {}) {
                        return (
                           !(function (t = [], n = {}) {
                              g !== e6.Init && (er.destroy(), (g = e6.Init)), (m = f({}, e7, n)), (v = M("id") || `fancybox-${++e8}`);
                              let r = e9.get(v);
                              if (
                                 (r && r.destroy(),
                                 e9.set(v, er),
                                 T("init"),
                                 (function () {
                                    for (let [e, t] of Object.entries({ ...tt.Plugins, ...(m.plugins || {}) }))
                                 ...
                                 (function () {
                                    ...
                                    if (!(t && t instanceof HTMLElement) || !(o = s(L(M("mainTpl") || "")) || void 0) || !((i = o.querySelector(".fancybox__container")) && i instanceof HTMLElement)) return;
                                    let n = M("mainClass");
                                    n && h(i, n);
                                    let r = M("mainStyle");
                                    if (r && l(r)) for (let [e, t] of Object.entries(r)) i.style.setProperty(e, t);
                                    let a = M("theme"),
                                       c = "auto" === a ? window.matchMedia("(prefers-color-scheme:light)").matches : "light" === a;
                                    i.setAttribute("theme", c ? "light" : "dark"),
                                       ...
                                       o.addEventListener(
                                          ...
                                          (t) => {
                                             ...
                                             (x = r), T("wheel", t, l), t.defaultPrevented || ("close" === o ? eo(t) : "slide" === o && e && !u(n) && (t.preventDefault(), e[l > 0 ? "prev" : "next"]()));
                                          },
                                          { capture: !0, passive: !1 }
                                       ),
                                       ...
                                       t.append(o),
                                       1 === e9.size && (M("hideScrollbar") && d(!0), document.documentElement.classList.add(te)),
                                 ...
                                 (function () {
                                    ...
                                    let t = f(
                                       {},
                                       {
                                          ...
                                          Fullscreen: { el: i },
                                          Toolbar: { absolute: !0, items: { counter: { tpl: '<div class="f-counter"><span data-fancybox-page></span>/<span data-fancybox-pages></span></div>' } }, display: { left: ["counter"], right: ["toggleFull", "autoplay", "fullscreen", "thumbs", "close"] } },
                                          Video: { autoplay: !0 },
                                          ...
                                          dragFree: !1,
                                          slidesPerPage: 1,
                                          plugins: { Sync: ew, Arrows: eP, Lazyload: eS, Zoomable: eb, Html: eV, Video: eq, Autoplay: e_, Fullscreen: eZ, Thumbs: eH, Toolbar: eI },
                                       },
                                       M("Carousel") || {},
                                 ...
                                 if (M("closeExisting")) for (let [e, t] of e9.entries()) e !== v && t.close();
                                 M("fadeEffect")
                                    ? (setTimeout(() => {
                                         P();
                                      }, 500),
            ...
            unbind: function (e, t) {
               ...
               if ((r(e) ? (o = e) : e instanceof Element && ((n = e), r(t) && (o = t)), n)) {
                  let e = tt.openers.get(n);
                  e && o && e.delete(o), (e?.size && o) || tt.openers.delete(n), n.removeEventListener("click", tt.fromEvent);
               }
            },
         };
